/*Procedure
1)use a doulbly LL, and maintain head,mid and count pointers
WHILE PUSHING,if count is even, move mid by 1 place ahead, if count is odd, dont move mid as its already in the right position
WHILE POPPING,if count is even after deleting, dont move mid, if odd, bring mid back by one
